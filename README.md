...
| Retornar um filme específico por id             | `/filmes/:id`             | `GET`       | Vazio                 | `200 OK`          | `404 Not Found` - Filme não encontrado.        |
| Cadastrar novo filme                            | `/filmes`                 | `POST`      | `Dados do filme`      | `201 Created`     | `400 Bad Request` - Dados inválidos.           |
| Atualizar um filme                              | `/filmes`                 | `UPDATE`    | `Dados do filme`      | `200 OK`          | `404 Not Found` - Filme não encontrado.        |
| Deletar um filme                                | `/filmes/:id`             | `DELETE`    | Vazio                 | `200 OK`          | `404 Not Found` - Filme não encontrado.        |
| Procurar um filme na API Externa por queryParam | `/buscar-filmes`          | `GET`       | `queryParam`          | `200 OK`          | `404 Not Found` - Filme não encontrado.        |
| Retornar todas as playlists                     | `/playlists`             | `GET`       | Vazio                 | `200 OK`          | `404 Not Found` - Nenhuma playlist encontrada. |
| Retornar os itens dentro da playlist específica | `/playlists/:id`          | `GET`       | Vazio                 | `200 OK`          | `404 Not Found` - Playlist não encontrada.     |
| Cadastrar uma nova playlist                     | `/playlists`              | `POST`      | `Dados da playlist`   | `201 Created`     | `400 Bad Request` - Dados inválidos.           |
| Atualizar uma playlist                          | `/playlists`              | `UPDATE`    | `Dados da playlist`   | `200 OK`          | `404 Not Found` - Playlist não encontrada.     |
| Deletar uma playlist                            | `/playlists/:id`          | `DELETE`    | Vazio                 | `200 OK`          | `404 Not Found` - Playlist não encontrada.     |
| Retornar todos os usuários                      | `/usuarios`              | `GET`       | Vazio                 | `200 OK`          | `404 Not Found` - Nenhum usuário encontrado.   |
| Retornar um usuário específico por id           | `/usuarios/:id`           | `GET`       | Vazio                 | `200 OK`          | `404 Not Found` - Usuário não encontrado.      |
| Cadastrar um novo usuário                       | `/usuarios`               | `POST`      | `Dados do usuário`    | `201 Created`     | `400 Bad Request` - Dados inválidos.           |
| Atualizar um usuário                            | `/usuarios`               | `UPDATE`    | `Dados do usuário`    | `200 OK`          | `404 Not Found` - Usuário não encontrado.      |
| Deletar um usuário                              | `/usuarios/:id`           | `DELETE`    | Vazio                 | `200 OK`          | `404 Not Found` - Usuário não encontrado.      |
